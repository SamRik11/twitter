  ...
  return (
    <div className='xl:w-[600px] hidden lg:inline ml-8 space-y-5'>
        ...
        <div className='sticky top-20 text-gray-700 space-y-3 bg-gray-100 pt-2 rounded-xl w-[90%] xl:w-[75%]'>
            ...
            <div key={user.id} className='flex item-center px-4 py-2 cursor-pointer hover:bg-gray-200'>
            ...
            <button onClick={()=>setRandUserNum(randUserNum+3)} className='text-blue-300 pl-4 hover:text-blue-300'>Show More</button>
        </div>
    </div>
  )
}
